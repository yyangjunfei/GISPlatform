package cc.wanshan.gis.entity.layer.provider;
...
public class PointDaoProvider {
    ...
    /**
     * description: 批量插入point
     *
     * @param map 封装pointlist集合
    ...
    public String insertAll(Map map) {
        ...
        MessageFormat messageFormat = new MessageFormat(
                "(#'{'list[{0}].featureName},#'{'list[{0}].layer.layerId},#'{'list[{0}].featureClass},st_geomfromgeojson(#'{'list[{0}].geom}),#'{'list[{0}].insertTime,jdbcType=TIMESTAMP},#'{'list[{0}].updateTime,jdbcType=TIMESTAMP},#'{'list[{0}].epsg},#'{'list[{0}].describe},#'{'list[{0}].fillColor},#'{'list[{0}].strokeColor},#'{'list[{0}].strokeWidth},#'{'list[{0}].opacity})");
