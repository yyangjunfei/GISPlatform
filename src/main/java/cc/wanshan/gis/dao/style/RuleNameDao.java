...
/**
 ...
 ON UPDATE NO ACTION
 ON DELETE NO ACTION,
 CONSTRAINT rule_name_style_id_fkey FOREIGN KEY (style_id)
 REFERENCES public.style (style_id) MATCH SIMPLE
 ON UPDATE CASCADE
 ON DELETE CASCADE,
...
public interface RuleNameDao {
  ...
  @Results({
      ...
      @Result(column = "rule_name_id",property = "ruleValue",
          many = @Many(select = "cc.wanshan.gis.dao.style.RuleValueDao.findRuleValuesByRuleNameId",fetchType = FetchType.LAZY))
  })
  /**
