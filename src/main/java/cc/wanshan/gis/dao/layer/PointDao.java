...
import cc.wanshan.gis.entity.provider.PointDaoProvider;
...
public interface PointDao {
  ...
  int insertAllPoint(@Param("list") List<Point> pointList);
  /**
   * description:
   *
   * @param layerId 图层名
   ...
   * @return java.util.List<cc.wanshan.gis.entity.drawlayer.Point>
   **/
  ...
  List<Point> findPoint(@Param("layerId") String layerId,
  ...
  List<Point> findPointByLayerId(@Param("layerId") String layerId);
  /**
   * description: 根据条件删除
   *
   * @param layerId 图层Id
  ...
  int deleteAll(@Param("list") List<Point> list);
}
