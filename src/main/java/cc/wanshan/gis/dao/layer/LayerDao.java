...
public interface LayerDao {
    ...
    @Results({
            ...
            @Result(column = "stroke_width", property = "strokeWidth"),
            @Result(column = "opacity", property = "opacity"),
            @Result(column = "layer_id", property = "pointList", many = @Many(select = "cc.wanshan.gis.dao.droplayer.PointDao.findPointByLayerId", fetchType = FetchType.LAZY)),
            @Result(column = "layer_id", property = "lineStringList", many = @Many(select = "cc.wanshan.gis.dao.droplayer.LineStringDao.findLineStringByLayerId", fetchType = FetchType.LAZY)),
            @Result(column = "layer_id", property = "polygonList", many = @Many(select = "cc.wanshan.gis.dao.droplayer.PolygonDao.findPolygonByLayerId", fetchType = FetchType.LAZY))
    })
    /**
    ...
    @Results({
            ...
            @Result(column = "stroke_width", property = "strokeWidth"),
            @Result(column = "opacity", property = "opacity"),
            @Result(column = "layer_name", property = "ruleNameList", many = @Many(select = "cc.wanshan.gis.dao.droplayer.RuleNameDao.findRuleNamesByLayerName", fetchType = FetchType.LAZY)),
    })
    /**
     * description:
     *
