...
public interface StyleDao {
    ...
    @Results({
            ...
            @Result(column = "style_id", property = "ruleNameList",
                    many = @Many(select = "cc.wanshan.gis.dao.droplayer.RuleNameDao.findRuleNamesByStyleId", fetchType = FetchType.LAZY))
    })
    /**
...
/*
  ...
  */
     ...
     *
     * @return cc.wanshan.gisdev.entity.authorize.style
     *//*
  public Style findStyleByUserName(String username);*/
     ...
     *
     * @param
     * @return java.util.List<cc.wanshan.gisdev.entity.authorize.style>
     */
