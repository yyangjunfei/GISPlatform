...
public interface FirstClassificationDao {
    ...
    @Results({
            ...
            @Result(column = "first_classification_id", property = "secondClassificationList", many = @Many(select = "cc.wanshan.gis.dao.thematic.SecondClassificationDao.findByFirstClassificationId", fetchType = FetchType.LAZY)),
    })
    /**
