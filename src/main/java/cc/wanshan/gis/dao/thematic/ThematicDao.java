...
public interface ThematicDao {
    ...
    @Results({
            ...
            @Result(column = "thematic_id", property = "firstClassificationList", many = @Many(select = "cc.wanshan.gis.dao.thematic.FirstClassificationDao.findByThematicId", fetchType = FetchType.LAZY)),
    })
    /**
     ...
     *
     * @param username
     * @return cc.wanshan.gisdev.entity.authorize.thematic
     */
     ...
     *
     * @param
     * @return java.util.List<cc.wanshan.gisdev.entity.authorize.thematic>
     */
