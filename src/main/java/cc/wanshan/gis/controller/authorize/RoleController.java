...
public class RoleController {
    ...
    public Result insertRole(@RequestBody JSONObject jsonObject) {
        ...
        Role role = new Role();
        if (StringUtils.isNotBlank(jsonObject.getString("roleName")) && StringUtils
                .isNotBlank(jsonObject.getString("roleNameZH")) && StringUtils
                .isNotBlank(jsonObject.getString("describe"))) {
    ...
    public Result updateRole(@RequestBody JSONObject jsonObject) {
        ...
        Role role = new Role();
        if (jsonObject != null && jsonObject.getInteger("roleId") != null
                && jsonObject.getInteger("roleId") != 0 && StringUtils
                .isNotBlank(jsonObject.getString("roleName")) && StringUtils
                .isNotBlank(jsonObject.getString("roleNameZH")) && StringUtils
                .isNotBlank(jsonObject.getString("describe"))) {
